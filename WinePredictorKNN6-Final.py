...
def MarvellousClassifier(DataPath):
    ...
    #finalized K=9 value after performing hyper parameter tunning, at this peak or for this K value we got
    # highest accuracy so we can finalized 9 as K value
    model=KNeighborsClassifier(n_neighbors=9)
    
    print("Classification model in created through KNeighborsClassifier")
    ...
    print("Accurancy of Model :",accurancy*100)
